% Reading the image
close all
I = imread('B. Disease Grading\1. Original Images\a. Training Set\0a4e1a29ffff.png');
...
Centroids = cat(1, I_red_props.Centroid);
...
red_Feats = [num_red, meanArea, meanPerimeter, meanSolidity];
disp(red_Feats)
...
%%
%
bright_props = regionprops(I_red5, 'All');
...
bright_Feats = [num_red, meanArea, meanPerimeter, meanSolidity];
disp(bright_Feats)
%% Fusion
